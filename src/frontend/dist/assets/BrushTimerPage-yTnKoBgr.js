import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, L as Link, m as motion, P as Play, w as RotateCcw, A as AnimatePresence } from "./index-D1mTBV0L.js";
/**
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "max-w-2xl mx-auto px-4 py-12", children: [
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h1",
                  {
                    ...
                    children: "2-Minute Brushing Guide"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Brush each quadrant for 30 seconds. Your dentist will be proud." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center mb-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-52 h-52", "data-ocid": "brush.timer_display", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "svg",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground mt-1", children: done ? "Complete!" : `Q${currentQuadrant + 1} of 4` })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mt-6", children: [
              !done && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    running ? /* @__PURE__ */ jsxRuntimeExports.jsx(Pause, { className: "w-4 h-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "w-4 h-4" }),
              ...
              children: quadrants.map((q) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.div,
                  {
                    ...
                    style: {
                      background: isCompleted ? "oklch(0.42 0.15 145 / 0.15)" : isActive ? "oklch(0.78 0.16 80 / 0.14)" : "oklch(0.12 0.008 60 / 0.85)",
                      borderColor: isCompleted ? "oklch(0.62 0.17 145 / 0.5)" : isActive ? "oklch(0.88 0.18 85)" : "oklch(0.22 0.015 60 / 0.5)"
                    },
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          style: {
                            color: isCompleted ? "oklch(0.62 0.17 145)" : isActive ? "oklch(0.88 0.18 85)" : "oklch(0.55 0.03 70)"
                          },
                          children: isCompleted ? "✓" : isActive ? "🦷" : "○"
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-bold text-foreground", children: q.label }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-0.5", children: q.teeth }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          className: "text-xs mt-1.5 font-semibold",
                          style: {
                            color: isCompleted ? "oklch(0.62 0.17 145)" : isActive ? "oklch(0.88 0.18 85)" : "oklch(0.45 0.02 60)"
                          },
                          children: isCompleted ? "Done" : isActive ? "Brushing now…" : "30 sec"
                        }
                      )
                    ]
                  },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: done && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    ...
                    children: "Brushing Complete!"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-5", children: "Your teeth are sparkling clean. Run a quick AI scan to check your oral health." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
                    to: "/scan",
                    ...
                    children: "Run AI Scan Now"
                  }
                )
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-center text-muted-foreground", children: "Tip: Brush in gentle circular motions. Never scrub side to side — it wears enamel." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "footer",
          {
