...
function calculateRisk(answers: Record<number, number>): RiskResult {
      ...
      <main className="max-w-2xl mx-auto px-4 py-12">
        ...
        >
          ...
          <p className="text-muted-foreground">
            10 quick questions. Personalised recommendations in seconds.
          </p>
        </motion.div>

        {!submitted ? (
          <>
            <div className="mb-8" data-ocid="quiz.progress_bar">
          ...
          result && (
            ...
            >
              ...
              >
                ...
                <p className="text-foreground/80 text-sm">{result.headline}</p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  Run AI Scan Now <ArrowRight className="w-4 h-4" />
                </Link>
                <button
                  type="button"
                  onClick={restart}
